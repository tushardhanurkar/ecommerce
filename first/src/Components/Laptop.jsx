...
const Laptop = () => {
  ...
  return (
    <div>
      ...
      <img src={ll} className="w-full h-80 object-fill"/>
          ...
          .map((items, index) => (
            ...
            >
              ...
              <div className='flex justify-around mt-3'>
                <button className='bg-blue-500 p-2 rounded-lg text-white cursor-pointer' onClick={() => navigate(`/buy/${items.id}`)} >  Buy Now
</button>
<button 
